...
## What it is
![What is mind mapping](WhatIsMindMapping.jpg ':size=300')\
...
## Application areas
![Application areas](FreeplaneOverview_en.jpg ':size=300')\
...
## Functions
![Freeplane functions](freeplaneFunctions.jpg ':size=300')\
...
* [Support for LaTeX formulae](../user-documentation/LaTeX_in_Freeplane.md) underneath/in nodes
* Easy extension of functionality with [add-ons](../getting-started/Add-ons_(install).md) and home made [scripts](../scripting/Scripting.md);
...
## Add-ons and Scripts
It is possible to extend the functionality of Freeplane using [Add-ons](../getting-started/Add-ons_(install).md) and [scripts](../scripting/Scripting ':ignore'). You can make your own add-ons and scripts using the built in scripting language Groovy (based on JavaScript), and beginning with version 1.5 other languages, like python. Check page [Add-ons_(install)](../getting-started/Add-ons_(install).md) for add-ons other users have made and shared. They can be downloaded and installed with a simple mouse click. [Instructions are available](../scripting/Add-ons_(Develop).md) if you want  to make your own add-ons.
...
# Documentation
![Tutorial](FreeplaneTutorial_en.jpg ':size=300')\
...
This wiki contains a page *[Freeplane_Tutorial_Extensions](Freeplane_Tutorial_Extensions.md)* with use cases which can be navigated or can be downloaded and extended. For some of the examples there are animations illustrating the making of the map. See [Translated wiki pages](../contribute/Translation_How-To ':ignore') if the page *Freeplane Tutorial Extensions* has been translated into your language. The advanced user is helped with detailed documentation in Freeplane's*Help > Documentation* and by many specific wiki pages explaining things like *[Scripting](../scripting/Scripting.md)*, *[Formulas](/#/scripting/Formulas.md)* and *[Add-ons](../getting-started/Add-ons_(install).md)*. The [mind map galleries](Mind_map_gallery.md) provide a place for sharing mind maps in several languages. Online help is available at the open Forum, see below. It is possible to create a high quality animation or video of using Freeplane, see [how to](Videos_and_animations_How-to.md).
...
[Join](../contribute/Contributing_to_Freeplane's_Development.md) the Freeplane [team](Contributors.md) not only as user but maybe as a
