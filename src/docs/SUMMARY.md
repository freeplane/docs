...
- [🤖 Scripts and Scripting. Start Here](scripting/Start_Here.md)
  ...
  - [References and Cheatsheet](scripting/References_and_Cheatsheet.md)
    ...
    - [Scripting API](scripting/Scripting_API.md)
  - [Advanced Topics](scripting/advanced_topics.md)
    ...
    - [Setting IDE for debugging](scripting/Setting_IDE_for_debugging.md)
    ...
    - [Scripting! Update Freeplane's Groovy version](scripting/Scripting!_Update_Freeplane's_Groovy_version.md)
