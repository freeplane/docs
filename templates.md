...
**Attention:**\
You can also change the default directory containing the user configuration. This means, the file-path for templates might differ therefore (see [The user directory](customizing-freeplane.md#the-user-directory)).
